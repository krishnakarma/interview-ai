...
const QuestionCard = ({ item, index }) => {
  ...
  return (
    <div className={`q-card ${open ? 'q-card--open' : ''}`}>
      <div className="q-card__header" onClick={() => setOpen(o => !o)} role="button" tabIndex={0} onKeyDown={e => e.key === 'Enter' && setOpen(o => !o)}>
        <span className="q-card__index">Q{index + 1}</span>
        <p className="q-card__question">{item.question}</p>
    ...
    <div className="interview-page">
      ...
      <div className="interview-layout">
        ...
        <nav className="interview-nav" aria-label="Sections">
          <div className="interview-nav__sections">
            <p className="interview-nav__label">Sections</p>
            {NAV_ITEMS.map(item => (
              <button
                key={item.id}
          ...
          {/* Score summary in nav on desktop */}
          <div className="interview-nav__score-mini">
            <p className="interview-nav__label">Match Score</p>
            <div className={`score-mini ${scoreColor}`}>
              <span className="score-mini__value">{report.matchScore}</span>
              <span className="score-mini__pct">%</span>
            </div>
          </div>

          <button className="btn btn--primary download-btn" onClick={handleDownload}>
            <svg height="14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className="interview-divider" aria-hidden="true" />
